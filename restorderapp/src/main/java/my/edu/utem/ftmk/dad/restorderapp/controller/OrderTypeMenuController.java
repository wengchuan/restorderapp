...
public class OrderTypeMenuController {
	private String defaultURI="http://localhost:8080/orderapp/api/ordertype";
	
	
	@GetMapping("/ordertype/list")
	public String getOrderTypes(Model model) {
		//The URI for GET order types
		String uri ="http://localhost:8080/orderapp/api/ordertype";
	...
	//this method is to delete OrderType
	//@param orderTypeId
	//@return
